  ...
  try
    ...
    begin
      ...
      try
        ...
        begin
          // JALUR EDIT: Hapus resep_obat (ON DELETE CASCADE akan otomatis menghapus resep_dokter karena constraint)
          vQuerySub.SQL.Clear;
        ...
        //vTglPerawatan := '0000-00-00'; // Default penanda belum terlayani apotek
        // AMANDEMEN: Ambil tgl_perawatan dari JSON jika dikirim, jika tidak ada gunakan '0000-00-00'
        ...
        vQuery.SQL.Clear;
        // KOREKSI UTAMA: Mengganti jam_rawat -> jam, serta menambahkan tgl_penyerahan & jam_penyerahan (NOT NULL)
        ...
        vQuery.ParamByName('jam').AsString            := vJamPeresepan; // Menyisi kolom `jam` agar tidak kosong
        ...
        vQuery.ParamByName('tgl_penyerahan').AsString := vTglPerawatan; // Default 0000-00-00
        vQuery.ParamByName('jam_penyerahan').AsString := '00:00:00';    // Default 00:00:00
        vQuery.ExecSQL;
        ...
        begin
          ...
          begin
            ...
            vQueryDetail.ParamByName('no_resep').AsString     := vNoResep;
            vQueryDetail.ParamByName('no_rawat').AsString     := vNoRawat;
